...
def preconisations(request):
    ...
    ("Reforestation",
     ...
     ("Education ", "intégrer dans les cursus scolires (collèges, lycées,  université) et peri-scolaire des temps d'apprentissage autour des enjeux du bouleversement climatique et des problématiques contemporaines."),
