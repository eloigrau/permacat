...
def preconisations(request):
    ...
    ("Reforestation",
     ...
     ("Education ", "intégrer dans les cursus des écoles (collèges, lycées,  université) et en peri-scolaire des temps d'apprentissage autour des enjeux du bouleversement climatique et des problématiques contemporaines."),
