...
def preconisations(request):
    ...
    ("Reforestation",
     ...
     ("Education ", "intégrer dans les cursus scolaires (collèges, lycées,  université) et peri-scolaires des temps d'apprentissage autour des enjeux dzq bouleversementq contemporains (climat, ressources, biodiversité."),
