...
ROOT_URLCONF = 'agoratransition.urls'
...
WSGI_APPLICATION = 'agoratransition.wsgi.application'
# Database
if LOCALL:
    DATABASES = {
       'default': {
...
AUTH_USER_MODEL = 'agoratransition.Profil_agora'
...
# Email settings
SERVER_EMAIL = 'festival.agoratransition@gmail.com'
...
GMAIL_SMTP_USER = 'festival.agoratransition@gmail.com'
EMAIL_SUBJECT_PREFIX = "[agoratransition]"
try:
...
ADMINS = (
    ('Asso_admin', 'festival.agoratransition@gmail.com'),
)
MANAGERS = ADMINS
BASE_URL = "https://agoratransition.herokuapp.com"
########################
...
# Extra places for collectstatic to find static files.
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'agoratransition/static_files'),
)
