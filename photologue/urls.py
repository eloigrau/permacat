...
urlpatterns = [
    ...
    url(r'^album/(?P<year>\d{4})/$', views.AlbumYearArchiveView.as_view(), name='album-archive-year'),
    url(r'^album/$', views.AlbumArchiveIndexView.as_view(), name='album-archive'),
    url(r'^$', RedirectView.as_view( url=reverse_lazy('photologue:album-archive'), permanent=True), name='photologue-root'),
    url(r'^album/(?P<slug>[\-\d\w]+)/$', views.AlbumDetailView.as_view(), name='album'),
    ...
    url(r'^photo/(?P<year>\d{4})/$', views.PhotoYearArchiveView.as_view(), name='photo-archive-year'),
    url(r'^photo/$', views.PhotoArchiveIndexView.as_view(), name='photo-archive'),
