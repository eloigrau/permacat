...
urlpatterns = [
    ...
    url(r'^cooperateurs/carte/$', login_required(views.profil_carte, login_url='/login/'), name='profil_carte',),
    ...
    url(r'^produits/lister/', login_required(views.ListeProduit.as_view(), login_url='/login/'),
        name="produit_lister"),
    url(r'^produits/lister_offres/', login_required(views.ListeProduit_offres.as_view(), login_url='/login/'),
        name="produit_lister_offres"),
    url(r'^produits/lister_recherches/', login_required(views.ListeProduit_recherches.as_view(), login_url='/login/'),
    ...
    url(r'^produits/contacterProducteur/(?P<producteur_id>[0-9]+)/$',
        login_required(views.produitContacterProducteur, login_url='/login/'), name='produit_contacterProducteur', ),
    ...
    url(r'^panier/supprimerItem/(?P<item_id>[0-9]+)',
        login_required(views.enlever_du_panier, login_url='/login/'), name='supprimerDuPanier', ),

    url(r'^requetes/afficher/$',
        login_required(views.afficher_requetes, login_url='/login/'), name='afficher_requetes', ),
]
